...
var SHA256 = /** @class */ (function () {
    ...
    SHA256.prototype.update = function (data) {
        ...
        var i, b = (this.buffer = bitarray_1.concat(this.buffer, data)), ol = this.length, nl = (this.length = ol + bitarray_1.bitLength(data));
    ...
    SHA256.prototype.finalize = function () {
        ...
        b = bitarray_1.concat(b, [bitarray_1.partial(1, 1)]);
...
function toBits(str) {
    ...
    if (i & 3) {
        out.push(bitarray_1.partial(8 * (i & 3), tmp));
    }
    return out;
}
function toHexBits(str) {
    ...
    return bitarray_1.clamp(out, len * 4);
}
function fromBits(arr) {
    ...
    return out.substr(0, bitarray_1.bitLength(arr) / 4); //.replace(/(.{8})/g, "$1 ");
}
